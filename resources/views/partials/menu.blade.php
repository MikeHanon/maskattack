    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endcan
                @can('meta_user_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.meta-users.index") }}" class="nav-link {{ request()->is('admin/meta-users') || request()->is('admin/meta-users/*') ? 'active' : '' }}">
                            <i class="fa-fw nav-icon fas fa-cogs">

                            </i>
                            <p>
                                {{ trans('cruds.metaUser.title') }}
                            </p>
                        </a>
                    </li>
                @endcan
